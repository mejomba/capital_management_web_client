...
> **وضعیت:** Milestone **M6 کامل** است — ۶a (اسکلت/API/احراز هویت)، ۶b (حساب‌ها، دارایی‌ها،
> قیمت‌ها، تراکنش‌ها، موجودی)، ۶c (بدهی‌ها و اهداف)، ۶d (داشبورد، گزارش‌ها: سود/زیان، بازدهی،
> تخصیص، مقایسه با تورم، پیش‌بینی؛ و تنظیمات assumptions/inflation).
